...
exports.addNewDog = exports.getAllDogs = undefined;
...
var getAllDogs = exports.getAllDogs = function getAllDogs() {
    var request = _axios2.default.get("https://reqres.in/api/users");
...
var addNewDog = exports.addNewDog = function addNewDog(dog) {
    return {
...
var editDog = function editDog() {};

var filterDogs = function filterDogs() {};

var deleteDogs = function deleteDogs() {};

var deleteAllDogs = function deleteAllDogs() {};
...
var GET_ALL_DOGS = exports.GET_ALL_DOGS = "GET_ALL_DOGS";
var ADD_NEW_DOG = exports.ADD_NEW_DOG = "ADD_NEW_DOG";
var EDIT_DOG = exports.EDIT_DOG = "EDIT_DOG";
var FILTER_DOGS = exports.FILTER_DOGS = "FILTER_DOGS";
var DELETE_DOG = exports.DELETE_DOG = "DELETE_DOG";
var DELETE_ALL_DOGS = exports.DELETE_ALL_DOGS = "DELETE_ALL_DOGS";
...
var _DogActions = __webpack_require__(12);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_store2.default.subscribe(function () {
  console.log("store", _store2.default.getState());
});

_store2.default.dispatch((0, _DogActions.getAllDogs)());
...
*/
var aa=__webpack_require__(7),l=__webpack_require__(18),B=__webpack_require__(3),C=__webpack_require__(2),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(4);
...
var _ShowDogs = __webpack_require__(82);

var _ShowDogs2 = _interopRequireDefault(_ShowDogs);

var _AddNewDog = __webpack_require__(103);

var _AddNewDog2 = _interopRequireDefault(_AddNewDog);

var _SomeData = __webpack_require__(104);

var _SomeData2 = _interopRequireDefault(_SomeData);
       ...
       _createClass(App, [{
              ...
              value: function render() {
                     return _React2.default.createElement(
                            ...
                            null,
                            "App",
                            _React2.default.createElement(_AddNewDog2.default, null),
                            _React2.default.createElement(_ShowDogs2.default, null),
                            _React2.default.createElement(_SomeData2.default, null)
                     );
              }
       }]);
...
var dogActions = _interopRequireWildcard(_DogActions);

var _reactRedux = __webpack_require__(11);

var _redux = __webpack_require__(6);

var _ListDog = __webpack_require__(102);

var _ListDog2 = _interopRequireDefault(_ListDog);
...
var stateProp = function stateProp(state) {
	return {
...
var dispatchProp = function dispatchProp(dispatch) {
	return {
		dog_action: function dog_action() {
			dispatch(dogActions.getAllDogs());
		}
	};
};

var ShowDogs = (_dec = (0, _reactRedux.connect)(stateProp, dispatchProp), _dec(_class = function (_Component) {
	_inherits(ShowDogs, _Component);

	function ShowDogs() {
		_classCallCheck(this, ShowDogs);

		return _possibleConstructorReturn(this, (ShowDogs.__proto__ || Object.getPrototypeOf(ShowDogs)).apply(this, arguments));
	}

	_createClass(ShowDogs, [{
		key: "componentDidMount",
		value: function componentDidMount() {
			this.props.dog_action();
			console.log("showdog comp actions", this.props.actions);
			console.log("showdog comp data", this.props.data);
		}
	}, {
		key: "render",
		value: function render() {
			return _React2.default.createElement(
				...
				_React2.default.createElement(_ListDog2.default, { dogsList: this.props.dogs })
			);
		}
	}]);
...
exports.default = function (props) {
	var dogs = props.dogsList.map(function (dog, index) {
		return _React2.default.createElement(
			'li',
			{ key: index },
			dog.fullname
...
var mapDisptachToProps = function mapDisptachToProps(dispatch) {
    return {
        actions: (0, _redux.bindActionCreators)(dogActions, dispatch)
    };
};

var AddNewDog = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDisptachToProps), _dec(_class = function (_Component) {
    _inherits(AddNewDog, _Component);

    function AddNewDog(props) {
        _classCallCheck(this, AddNewDog);

        var _this = _possibleConstructorReturn(this, (AddNewDog.__proto__ || Object.getPrototypeOf(AddNewDog)).call(this, props));
    ...
    _createClass(AddNewDog, [{
        key: "handleAddDog",
        value: function handleAddDog() {
            // get and set  variables
            var firstname = this.newdog_firstname;
            ...
            return _React2.default.createElement(
                ...
                _React2.default.createElement("input", {
                    ...
                    ref: function ref(input) {
                        return _this2.newdog_firstname = input;
                    },
                    name: "firstname",
...
var SomeData = (_dec = (0, _reactRedux.connect)(stateProp, dispatchProp), _dec(_class = function (_Component) {
	_inherits(SomeData, _Component);
	...
	_createClass(SomeData, [{
		key: "componentDidMount",
		value: function componentDidMount() {
			this.props.actions.getAllDogs();
			// console.log("SomeData", this.props);
		}
	}, {
		key: "render",
		value: function render() {
			// let data = this.props.data.map((data, index) => <div key={index}>{data}</div>);
...
var store = (0, _redux.createStore)(_reducers2.default, {}, middleware, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
var _dogReducer = __webpack_require__(107);
...
var rootReducer = (0, _redux.combineReducers)({
    dogReducer: _dogReducer2.default
});
...
var dogReducer = function dogReducer() {
    ...
    switch (action.type) {
        ...
        case constant.ADD_NEW_DOG:
            return _extends({}, state, {
                dogs: [].concat(_toConsumableArray(state.dogs), [action.payload])
            });
